...
exports.getAllConcepts = exports.orderedCloneDeep = exports.assignInstanceFromRawValue = exports.isReferenceType = exports.isModifierExtension = exports.isExtension = exports.getTypeFromFshDefinitionOrParent = exports.getVersionFromFshDefinition = exports.getUrlFromFshDefinition = exports.isInheritedResource = exports.applyInsertRules = exports.cleanResource = exports.replaceField = exports.getSliceName = exports.listUndefinedLocalCodes = exports.replaceReferences = exports.getArrayIndex = exports.setPropertyOnInstance = exports.setImpliedPropertiesOnInstance = exports.determineKnownSlices = exports.createUsefulSlices = exports.setPropertyOnDefinitionInstance = exports.splitOnPathPeriods = exports.LOGICAL_TARGET_EXTENSION = exports.TYPE_CHARACTERISTICS_CODE = exports.TYPE_CHARACTERISTICS_EXTENSION = void 0;
            ...
            for (const [i, pathPart] of pathParts.entries()) {
                ...
                if (ruleIndex != null) {
                    ...
                    if (sliceName) {
                        ...
                        const sliceExtensionUrl = (_b = fisher.fishForMetadata(sliceName)) === null || _b === void 0 ? void 0 : _b.url;
                        (_c = current[pathPart.base]) === null || _c === void 0 ? void 0 : _c.forEach((el, i) => {
                        ...
                        knownSlices.set(currentPath, Math.max(ruleIndex + 1, (_d = knownSlices.get(currentPath)) !== null && _d !== void 0 ? _d : 0));
                    }
...
function setPropertyOnInstance(instance, pathParts, assignedValue, fisher, manualSliceOrdering = false) {
    var _a, _b, _c;
        ...
        for (const [i, pathPart] of pathParts.entries()) {
            ...
            if (index != null) {
                ...
                if (sliceName) {
                    ...
                    const sliceIndices = [];
                    (_c = current[pathPart.base]) === null || _c === void 0 ? void 0 : _c.forEach((el, i) => {
                        if ((el === null || el === void 0 ? void 0 : el._sliceName) == null) {
                            sliceIndices.push(i);
                        }
                    });
                    // Convert the index in terms of the slice to the corresponding index in the overall array
...
function replaceReferences(rule, tank, fisher) {
    ...
    if (value instanceof fshtypes_1.FshReference) {
        ...
        const codeSystemMeta = (0, utils_1.fishForMetadataBestVersion)(fisher, value.system, rule.sourceInfo, Fishable_1.Type.CodeSystem);
        if (codeSystemMeta) {
            clone = (0, lodash_1.cloneDeep)(rule);
 ...
 */
function getValueFromFshRules(fshDefinition, assignmentRulePath, caretRulePath, caretRuleCaretPath) {
    const fshRules = fshDefinition.rules;
    if (fshDefinition instanceof fshtypes_1.Instance) {
        const assignmentRules = fshRules.filter(rule => rule instanceof rules_1.AssignmentRule &&
        ...
        const caretValueRules = fshRules.filter(rule => rule instanceof rules_1.CaretValueRule &&
 ...
 */
function assignInstanceFromRawValue(target, rule, instanceExporter, fisher, originalErr) {
    ...
    if (instance == null) {
        ...
        try {
            setPropertyOnDefinitionInstance(target, rule.path.length > 1 ? `${rule.path}.${rule.caretPath}` : rule.caretPath, instance, fisher);
        }
        catch (instanceErr) {
...
exports.assignInstanceFromRawValue = assignInstanceFromRawValue;
/**
