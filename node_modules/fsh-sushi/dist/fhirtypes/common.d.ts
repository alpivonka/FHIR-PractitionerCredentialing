...
export declare function setPropertyOnInstance(instance: StructureDefinition | ElementDefinition | InstanceDefinition | ValueSet | CodeSystem, pathParts: PathPart[], assignedValue: any, fisher: Fishable, manualSliceOrdering?: boolean): void;
/**
 ...
 */
export declare function assignInstanceFromRawValue(target: CodeSystem | ValueSet, rule: CaretValueRule, instanceExporter: InstanceExporter, fisher: Fishable, originalErr: MismatchedTypeError): void;
/**
