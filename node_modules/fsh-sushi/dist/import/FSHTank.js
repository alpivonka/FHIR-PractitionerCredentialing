                ...
                if (result instanceof fshtypes_1.Logical) {
                    ...
                    if (result.characteristics.includes('can-be-target')) {
                        ...
                        const extensionUrlRules = result.rules.filter(rule => {
                            return (rule instanceof rules_1.CaretValueRule &&
                                rule.path === '' &&
                        ...
                        for (const [idx, url] of extensionUrls.entries()) {
                            if (url === common_1.TYPE_CHARACTERISTICS_EXTENSION) {
                                ...
                                const valueRule = result.rules
                                    ...
                                    .pop();
                                if (valueRule &&
                                    valueRule.value instanceof fshtypes_1.FshCode &&
                                    valueRule.value.code === 'can-be-target') {
                                    meta.canBeTarget = true;
                                    break;
                                }
                            }
                            else if (url === common_1.LOGICAL_TARGET_EXTENSION) {
                                ...
                                const valueRule = result.rules
                                    ...
                                    .pop();
                                if ((valueRule === null || valueRule === void 0 ? void 0 : valueRule.value) === true) {
                                    meta.canBeTarget = true;
                                    break;
                                }
                            }
