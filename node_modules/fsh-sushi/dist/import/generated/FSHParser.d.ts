...
declare namespace FSHParser {
    ...
    export const KW_CONTEXT: number;
    export const KW_CHARACTERISTICS: number;
    ...
    export const CODEABLE_REFERENCE: number;
    ...
    export const QUOTED_CONTEXT: number;
    export const LAST_QUOTED_CONTEXT: number;
    export const UNQUOTED_CONTEXT: number;
    export const LAST_UNQUOTED_CONTEXT: number;
    export const CONTEXT_WHITESPACE: number;
    export const CODE_ITEM: number;
    export const LAST_CODE_ITEM: number;
    export const CODE_LIST_WHITESPACE: number;
    ...
    export const RULE_context: number;
    export const RULE_contextItem: number;
    export const RULE_lastContextItem: number;
    export const RULE_characteristics: number;
    ...
    export const RULE_codeableReferenceType: number;
...
declare class ContextItemContext extends antlr4.ParserRuleContext {
    ...
    parser: any;
    ruleIndex: number;
    QUOTED_CONTEXT(): antlr4.Token;
    UNQUOTED_CONTEXT(): antlr4.Token;
    enterRule(listener: any): void;
    exitRule(listener: any): void;
    accept(visitor: any): any;
}
declare class LastContextItemContext extends antlr4.ParserRuleContext {
    ...
    parser: any;
    ruleIndex: number;
    LAST_QUOTED_CONTEXT(): antlr4.Token;
    LAST_UNQUOTED_CONTEXT(): antlr4.Token;
    enterRule(listener: any): void;
    exitRule(listener: any): void;
    accept(visitor: any): any;
}
declare class CharacteristicsContext extends antlr4.ParserRuleContext {
    ...
    parser: any;
    ruleIndex: number;
    KW_CHARACTERISTICS(): antlr4.Token;
    LAST_CODE_ITEM(): antlr4.Token;
    CODE_ITEM: (i: any) => any;
    enterRule(listener: any): void;
    exitRule(listener: any): void;
    accept(visitor: any): any;
...
declare class CodeableReferenceTypeContext extends antlr4.ParserRuleContext {
    ...
    parser: any;
    ruleIndex: number;
    CODEABLE_REFERENCE(): antlr4.Token;
    enterRule(listener: any): void;
    exitRule(listener: any): void;
    accept(visitor: any): any;
}
