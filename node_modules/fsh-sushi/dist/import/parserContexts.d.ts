...
export declare type NameContext = ParserRuleContext;
...
export declare function isStarContext(ctx: ParserRuleContext): ctx is StarContext;
export interface StarContext extends ParserRuleContext {
    STAR(): ParserRuleContext & TerminalNode;
}
export declare function containsPathContext(ctx: ParserRuleContext): boolean;
export declare function containsCodePathContext(ctx: ParserRuleContext): boolean;
export declare function hasPathRule(ctx: ParserRuleContext): boolean;
