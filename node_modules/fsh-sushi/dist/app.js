...
function app() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        program
            ...
            return __awaiter(this, void 0, void 0, function* () {
                yield runBuild(projectPath, options, program.helpInformation()).catch(logUnexpectedError);
            });
        })
            .on('--help', () => {
            console.log('');
        ...
        program
            ...
            .action(function () {
            return __awaiter(this, void 0, void 0, function* () {
                yield (0, utils_1.init)().catch(logUnexpectedError);
        ...
        program
            ...
            return __awaiter(this, void 0, void 0, function* () {
                yield runUpdateDependencies(projectPath).catch(logUnexpectedError);
                process_1.default.exit(0);
            });
        })
            .on('--help', () => {
...
function runUpdateDependencies(projectPath) {
    return __awaiter(this, void 0, void 0, function* () {
        const input = (0, utils_1.ensureInputDir)(projectPath);
        const config = (0, utils_1.readConfig)(input);
        yield (0, utils_1.updateExternalDependencies)(config);
    });
}
function runBuild(input, program, helpText) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (program.logLevel != null) {
            ...
            utils_1.logger.level = program.logLevel;
        }
        ...
        const sushiVersions = yield (0, utils_1.checkSushiVersion)();
        if (program.requireLatest &&
        ...
        yield (0, utils_1.loadExternalDependencies)(defs, config);
        ...
        (0, utils_1.writeFHIRResources)(outDir, outPackage, defs, program.snapshot);
        if (program.preprocessed) {
